...
_otmLogoFallback = "দৈনিক চাঁদপুর দর্পণ";


var _otmLogo = (typeof ot === "undefined") ? ((typeof _otmLogo === "undefined") ? _otmLogoFallback : _otmLogo) : ((typeof ot._otmLogo === "undefined") ? ((typeof ot.theme_full_name === "undefined") ? _otmLogoFallback : ot.theme_full_name) : '<img src="' + ot._otmLogo + '" alt="" />');

_otmLogo = "দৈনিক চাঁদপুর দর্পণ";//overriding _otmLogo
...
(function() {
    ...
    if (typeof document.getElementById("boxed") != "undefined") {
        document.getElementById("boxed").insertAdjacentHTML("beforeend", '<div class="ot-responsive-menu-header"><a href="#" id="ot-menu-burger-1" class="ot-responsive-menu-header-burger"></a><a href="/" class="ot-responsive-menu-header-logo">' + "দৈনিক চাঁদপুর দর্পণ" + '</a><span id="ot-responsive-menu-header-list"></span></div>');
